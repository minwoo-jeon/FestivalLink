        ...
        <table class='table'>
            <tr>
                ...
                <td width="80%" class="m2">
                    <div class="row">
                        <div class="col-3">
                            <input type="email" name="email" id="email" oninput="checkEmail()" placeholder="이메일을 입력해주세요">
                         <br>
                         <!-- id ajax 중복체크 -->
            ...
            <tr>
                ...
                <td width="80%" class="m2">
                    <div class="row">
                        <div class="col-6">
                            <input type="text" class="mail-check-input" placeholder="인증번호를 입력해주세요"">
                            </div>
            ...
            <tr>
                ...
                <td width="80%" class="m2">
                    <div class="row">
                        <div class="col-6">
                            <input type="text" name="nickname" id="nickname" oninput="checkNickname()" placeholder="닉네임을 입력하세요">
                        <br>
                        <!-- nickname ajax 중복체크 -->
