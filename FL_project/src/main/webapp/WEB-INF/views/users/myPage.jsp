            ...
            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-10 mt-3 mb-5 mx-auto" style="">
                ...
                <div class="hexagon-menu clear mx-auto" style="display: flex; justify-content: center; align-items: center;">
                    <div class="hexagon-item mx-auto">
                        ...
                        <a class="hex-content" href="/users/modify">
                            <span class="hex-content-inner">
                                <span class="icon">
                                    <i class="fa fa-universal-access"></i>
                                </span>
                                <span class="title"><b>내 정보 수정</b></span>
                            </span>
                     ...
                     <div class="hexagon-item mx-auto">
                                            ...
                                            <a class="hex-content" href="/users/mypage/delete">
                                                <span class="hex-content-inner">
                                                    <span class="icon">
                                                        <i class="fa fa-bullseye"></i>
                                                    </span>
                                                    <span class="title"><b>회원 탈퇴</b></span>
                                                </span>
                                                <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div class="hexagon-item mx-auto">
                        ...
                        <a class="hex-content" href="/users/myReview/1">
                            <span class="hex-content-inner">
                                <span class="icon">
                                    <i class="fa fa-universal-access"></i>
                                </span>
                                <span class="title"><b>내가 쓴 리뷰</b></span>
                            </span>
                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="hexagon-item mx-auto">
                        ...
                        <a class="hex-content" href="/users/likedReview/1">
                            <span class="hex-content-inner">
                                <span class="icon">
                                    <i class="fa fa-bullseye"></i>
                                </span>
                                <span class="title"><b>내가 좋아요한 리뷰</b></span>
                            </span>
                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="hexagon-item mx-auto">
                        ...
                        <a class="hex-content" href="/users/myFestival/1">
                            <span class="hex-content-inner">
                                <span class="icon">
                                    <i class="fa fa-id-badge"></i>
                                </span>
                                <span class="title"><b>내가 좋아요한 축제</b></span>
                            </span>
                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <c:if test="${user.state eq 3}">
                        <div class="hexagon-item mx-auto">
                            ...
                            <a class="hex-content" href="/users/report">
                                <span class="hex-content-inner">
                                    <span class="icon">
                                        <i class="fa fa-braille"></i>
                                    </span>
                                    <span class="title"><b>신고보기</b></span>
                                </span>
                                <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
