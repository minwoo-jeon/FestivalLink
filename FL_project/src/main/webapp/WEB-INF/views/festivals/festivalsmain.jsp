...
<div class="container">
    ...
    <form action="search" method="POST">
        <div class="input-group">
            <input type="text" class="form-control" name="keyword" id="searchKeyword" placeholder="검색어를 입력하세요" value="Search">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#searchForm').submit(function (event) {
                ...
                // 키워드를 이용해 검색 기능 구현
                searchFestivalsByKeyword(keyword);
            });
        });

        function searchFestivalsByKeyword(keyword) {
            $.ajax({
                url: './search',
                type: 'POST',
                data: { keyword: keyword },
                success: function (response) {
                    // 서버로부터 검색 결과를 받아 처리하는 로직 작성
